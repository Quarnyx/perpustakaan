! function (n) {
    ...
    n("#side-menu").metisMenu(), n("#vertical-menu-btn").on("click", function (e) {
            ...
            var asa = window.location.search.split('&')[0];
            if(this.getAttribute('href') === asa){n(this).addClass("active"), n(this).parent().addClass("mm-active"), n(this).parent().parent().addClass("mm-show"), n(this).parent().parent().prev().addClass("mm-active"), n(this).parent().parent().parent().addClass("mm-active"), n(this).parent().parent().parent().parent().addClass("mm-show"), n(this).parent().parent().parent().parent().parent().addClass("mm-active")}
        }), n(".navbar-nav a").each(function () {
            var asb = window.location.search.split('&')[0];
            if(this.getAttribute('href') === asb){n(this).addClass("active"), n(this).parent().addClass("active"), n(this).parent().parent().addClass("active"), n(this).parent().parent().parent().addClass("active"), n(this).parent().parent().parent().parent().addClass("active"), n(this).parent().parent().parent().parent().parent().addClass("active")}
