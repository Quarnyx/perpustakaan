        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="get" id="form-filter">
                    <input type="hidden" name="page" value="lap_buku_masuk">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Data Buku Masuk</h4>
                ...
                <a class="btn btn-info waves-effect waves-light" target="_blank"
                    href="pages/laporan-buku-masuk/cetak-bukumasuk.php<?php if (isset($_GET['dari_tanggal'])) { ?>?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
                        class="ri-printer-line align-middle me-2"></i>Cetak</a>
                <a class="btn btn-danger waves-effect waves-light" target="_blank"
                    href="pages/laporan-buku-masuk/cetak-bukumasuk-pdf.php<?php if (isset($_GET['dari_tanggal'])) { ?>?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
                        class="ri-printer-line align-middle me-2"></i>Cetak PDF</a>
                <a class="btn btn-success waves-effect waves-light" target="_blank"
                    href="pages/laporan-buku-masuk/cetak-bukumasuk-excel.php<?php if (isset($_GET['dari_tanggal'])) { ?>?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
