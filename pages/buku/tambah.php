        ...
        <div class="row">
                ...
                <div class="card border border-primary">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-5">
                            ...
                            <img id="preview" src="assets/images/books/default.png" alt="avatar-5"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul" placeholder="Judul Buku" required=""
                        name="judul">
                </div>
                <div class="row">
...
<script>
    ...
    $("#formBuku").submit(function (e) {
        ...
        $.ajax({
            url: "pages/buku/proses-buku.php?act=tambahBuku",
            type: "POST",
