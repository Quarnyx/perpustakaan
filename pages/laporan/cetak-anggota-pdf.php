...
$pdf->Cell(0, 7, 'LAPORAN ANGGOTA PERPUSTAKAAN', 0, 1, 'C');
...
$pdf->Cell(100, 6, 'Nama Anggota', 1, 0, 'C');
$pdf->Cell(50, 6, 'Kontak', 1, 0, 'C');
$pdf->Cell(75, 6, 'Email', 1, 1, 'C');
...
while ($data = mysqli_fetch_array($hasil)):
    ...
    $pdf->Cell(25, 6, $data['nis'], 1, 0);
    $pdf->Cell(100, 6, $data['nama_anggota'], 1, 0);
    $pdf->Cell(50, 6, $data['no_telp'], 1, 0);
    $pdf->Cell(75, 6, $data['email'], 1, 1);
    $no++;
endwhile;
