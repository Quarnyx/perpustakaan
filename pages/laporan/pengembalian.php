        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="get" id="form-filter">
                    <input type="hidden" name="page" value="lap_pengembalian">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-info waves-effect waves-light" target="_blank"
                    href="pages/laporan/cetak-pengembalian.php<?php if (isset($_GET['dari_tanggal'])) { ?>?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
                        class="ri-printer-line align-middle me-2"></i>Cetak</a>
                <a class="btn btn-danger waves-effect waves-light" target="_blank"
                    href="pages/laporan/cetak-pengembalian-pdf.php<?php if (isset($_GET['dari_tanggal'])) { ?>?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
                        class="ri-printer-line align-middle me-2"></i>Cetak PDF</a>
                <a class="btn btn-success waves-effect waves-light" target="_blank"
                    href="pages/laporan/cetak-pengembalian-excel.php<?php if (isset($_GET['dari_tanggal'])) { ?> ?dari_tanggal=<?= $_GET['dari_tanggal'] ?>&sampai_tanggal=<?= $_GET['sampai_tanggal'] ?><?php } ?>"><i
