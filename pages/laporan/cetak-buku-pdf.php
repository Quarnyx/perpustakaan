...
$pdf->Cell(0, 7, 'LAPORAN KATALOG BUKU', 0, 1, 'C');
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->Cell(50, 6, $data['nama_buku'], 1, 0);
    $pdf->Cell(50, 6, $data['nama_penulis'], 1, 0);
    $pdf->Cell(50, 6, $data['nama_penerbit'], 1, 0);
    $pdf->Cell(50, 6, $data['nama_supplier'], 1, 0);
    $pdf->Cell(15, 6, $data['tahun'], 1, 0);
    $pdf->Cell(15, 6, $data['stok'], 1, 0);
    $pdf->Cell(15, 6, $data['rak'], 1, 1, 'C');
    $no++;
}
